...
<div class="main">
  ...
  <main class="content">
    <div class="timeline">
      ...
      <!-- EVENTI GENERATI DAL TUO XML CON RIFERIMENTI TEI -->
      ...
      <div class="tl-event type-biografico" onclick="toggle(this)">
        ...
        <div class="tl-inner">
          ...
          <div class="tl-tei-block">
            <div class="tei-label">riferimento TEI</div>
            &lt;event type="Biografico"&gt;<br>
            &nbsp;&nbsp;&lt;head&gt;Nascita di Eugenio Montale&lt;/head&gt;<br>
            &nbsp;&nbsp;&lt;date when="1896-10-12"/&gt;<br>
            &lt;/event&gt;
          </div>
        </div>
      </div>
      ...
      <div class="tl-event type-biografico" onclick="toggle(this)">
        ...
        <div class="tl-inner">
          ...
          <div class="tl-tei-block">
            <div class="tei-label">riferimento TEI</div>
            &lt;event type="Biografico"&gt;<br>
            &nbsp;&nbsp;&lt;head&gt;Nascita di Irma Brandeis&lt;/head&gt;<br>
            &nbsp;&nbsp;&lt;date when="1905"/&gt;<br>
            &lt;/event&gt;
          </div>
        </div>
      ...
      <div class="tl-event type-letterario" onclick="toggle(this)">
        <div class="tl-dot-wrap"><div class="tl-dot"></div></div>
        <div class="tl-inner">
          <div class="tl-date">15 giugno 1925</div>
          <div class="tl-label">Pubblicazione degli Ossi di seppia</div>
          <span class="tl-tag tag-poetico">letterario</span>
          <div class="tl-desc">Prima raccolta poetica di Montale, pubblicata da Gobetti.</div>
          <div class="tl-tei-block">
            <div class="tei-label">riferimento TEI</div>
            &lt;event type="Letterario"&gt;<br>
            &nbsp;&nbsp;&lt;head&gt;Pubblicazione degli Ossi di seppia&lt;/head&gt;<br>
            &nbsp;&nbsp;&lt;date when="1925-06-15"/&gt;<br>
            &lt;/event&gt;
          </div>
        </div>
      </div>
      ...
      <div class="tl-event type-accademico" onclick="toggle(this)">
        ...
        <div class="tl-inner">
          ...
          <div class="tl-desc">Montale viene nominato direttore del Gabinetto Vieusseux di Firenze.</div>
          <div class="tl-tei-block">
            <div class="tei-label">riferimento TEI</div>
            &lt;event type="Accademico"&gt;<br>
            &nbsp;&nbsp;&lt;orgName&gt;Gabinetto Scientifico Letterario G.P. Vieusseux&lt;/orgName&gt;<br>
            &lt;/event&gt;
          </div>
        </div>
      </div>
